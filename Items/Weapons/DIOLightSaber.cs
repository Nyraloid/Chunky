...
{
    public class DIOLightSaber : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Timely Lightsaber");
            Tooltip.SetDefault("A practical sword.\n'UNLIMITED POWER'");
        }
        ...
        public override void AddRecipes()
        {
            ...
            //recipeE.AddIngredient(null, "GloryHammer", 1); //It's literally the same thing
