...
namespace Chunky.Tiles
{
	...
	public class ObsidianHerb : ModTile
	{
		...
		public override bool Drop(int i, int j)
		{
			...
			if (stage == PlantStage.Grown) if (Main.rand.Next(0, 10) == 0) Item.NewItem(new Vector2(i, j).ToWorldCoordinates(), mod.ItemType("GeodeObsidian")); else Item.NewItem(new Vector2(i, j).ToWorldCoordinates(), mod.ItemType("Obstidian"));
